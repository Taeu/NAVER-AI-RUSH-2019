...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=8) # change
    ...
    if args.mode == "train":
        ...
        for cvf in range(5):
            ...
            print(cvf)
            bind_model(model)            
            nsml.load(checkpoint='5',session='team_62/airush1/69')
            ...
            print(meta_data_val.shape)
            print(label_val.shape)
            print(meta_data_train.head(5))
            print(meta_data_val.head(5))


            for epoch_idx in range(1,args.epochs +1):
                dataloader_train = train_dataloader(meta_data_train, args.input_size, args.batch_size, args.num_workers, label_matrix = label_train )
                ...
                **{
                ...
                "valid__Loss": total_correct_valid /(batch_len_valid),
                })
