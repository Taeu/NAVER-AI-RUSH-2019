...
class OctConv2d(nn.modules.conv._ConvNd):
    ...
    def __init__(self, oct_type, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, bias=True, alpha_in=0.5, alpha_out=0.5, padding_mode='zeros'):
        ...
        super(OctConv2d, self).__init__(
            ...
            False, _pair(0), 1, bias, padding_mode)
